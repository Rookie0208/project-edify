              ...
              <div className="social-fields">
                ...
                <div className="fields flex flex-col">
                  <div className="social-field">
                    <i class="zmdi zmdi-twitter material-icons-name mr-2"></i><input type="text" className='input-field border-2' />
                  </div>
                  <div className="social-field">
                    <i class="zmdi zmdi-instagram material-icons-name mr-2"></i><input type="text" className='input-field border-2' />
                  </div>
                  <div className="social-field">
                    <i class="zmdi zmdi-linkedin material-icons-name mr-2"></i><input type="text" className='input-field border-2' />
